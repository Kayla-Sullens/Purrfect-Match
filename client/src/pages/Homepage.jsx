                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p>Our mission is to help each of our cats find their Purrfect family, one match at a time.</p>
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="cat_info">
                                ...
                                <div className="cat_content">
                                    <h5>Tip #3</h5>
                                    <p>How much fur can you handle? Different breeds have different fur and shedding habits, so keep this in mind.</p>
                                    <a href="#">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div className="col">
                            <div className="cat_info">
                                <div className="cat_thumbn"><img src="./src/assets/whitecat.png" alt="" /></div>
                                <div className="cat_content">
                                    <h5>Tip #4</h5>
                                    <p>Consider your lifestyle. While most cats do not need as much attention and care as other pets, they do still need daily care.</p>
                                    <a href="#">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div className="col">
                            <div className="cat_info">
                                <div className="cat_thumbn"><img src="./src/assets/boycat.png" alt="" /></div>
                                <div className="cat_content">
                                    <h5>Tip #5</h5>
